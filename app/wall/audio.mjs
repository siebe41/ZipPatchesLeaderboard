...
export function createAudio(startMuted = true) {
  ...
  const effects = {
    hit: () => tone('square', 300, 500, 0.05, 0.3),
    wall: () => tone('sine', 500, 380, 0.04, 0.18),
    point: () => arp([523, 659, 784], 0.06, 'square', 0.45),
    miss: () => { noise(0.24, 1200, 0.5); tone('sawtooth', 340, 80, 0.3, 0.35); },
