 ...
 * dictate: the angle a fresh serve leaves the centre line at. Everything
 * else -- paddle motion, ball physics -- is a consequence of the level and
 * the player's inputs, so a run replays from its seed and its input trace
 * alone.
 *
