...
export function createAudio(startMuted = true) {
  ...
  const effects = {
    fire: () => tone('square', 700, 1100, 0.05, 0.24),
    explode: () => { noise(0.22, 1800, 0.5); tone('sine', 260, 90, 0.2, 0.3); },
    kill: () => tone('square', 900, 1400, 0.05, 0.3),
    endpointlost: () => { noise(0.3, 800, 0.5); tone('sawtooth', 220, 50, 0.4, 0.35); },
